...
\begin{fig}
	...
	\end{center}
	\caption{Figura: grafico comparativo dei risultati prodotti da 10 differenti AI di Sentyment. In questo caso è analizzata la funzione \textit{performance} (Formula 6) per ciascuna delle AI prese in considerazione. La funzione è calcolata partendo dall'inizio del dataset (BITCOIN-EURO a partire da inizio 2014, fino ad inizio 2020) in intervalli di 250 candele orarie. Alcune AI si posizionano sempre in alto rispetto ad altre, ed è per questo motivo che è necessario sceglierne una migliore fra tutte.}
\end{fig}
...
\begin{fig}
	\begin{center}
		\includegraphics[width=\linewidth]{performance_ai_250}
	\end{center}
	\caption{\\~\\Figura: Grafico riassuntivo delle performance delle 10 AI considerate per il training di \textit{meta-learner}. Le performance sono calcolate a step di 250 candele (circa 10 giorni) ed utilizzando la Formula (6). Sono fortemente correlate all'andamento dei prezzi. Questi sono i dati calcolati dal supervisore per il suo training: ha una ricompensa positiva se, all'interno di ogni step, sceglie la AI che ha un valore più alto di performance. Come si può notare, all'inizio, ci sono pochi picchi di performance e soprattutto da parte di AI\_0 (blu). Continuando più avanti nel tempo, i picchi compaiono sempre più spesso, sono più accentuati e sono prodotti da sempre più AI, risultato di un training di Sentyment che si adatta sempre di più ai dati e produce risultati sempre migliori.}
\end{fig}
...
%TODO: Immagini tutte nello stesso box!!!
\begin{fig}
	\begin{center}
		\includegraphics[width=\linewidth]{performance_ai0}
		\includegraphics[width=\linewidth]{performance_ai8}
		\includegraphics[width=\linewidth]{performance_ai7}
		\includegraphics[width=\linewidth]{performance_ai2}
		\includegraphics[width=\linewidth]{performance_ai_mean}
	\end{center}
	\caption{\\~\\Figura: performance di diverse AI a confronto, isolate dal grafico : la migliore (AI\_0), la seconda e terza posizione (AI\_8 e AI\_7), l'ultima (AI\_2) e la media di tutte.}
\end{fig}
