...
\begin{thefigure}
	...
	\end{center}
	\captionof{figure}{Esempio di grafico dei prezzi di chiusura di BITCOIN-EURO in un certo periodo, ed i \textit{trigger} di una AI di Sentyment. Si nota che i segnali buy / sell non corrispondono esattamente fra una AI e l'altra, confrontando questo grafico con la prossima immagine, ma sono leggermente spostati. Ognuna produce strategie differenti e, anche se probabilmente molte AI identificano gli stessi trend nel grafico, alcune potrebbero decidere di comprare, o vendere, leggermente prima, o dopo, rispetto alle altre.}\label{Figura 14}
\end{thefigure}
\begin{thefigure}
	\begin{center}
		\includegraphics[width=\linewidth]{ai_trigger2}
	\end{center}
	\captionof{figure}{Secondo grafico dei prezzi di chiusura per lo stesso ticker e periodo temporale del precedente. È considerata una differente AI questa volta, ed i segnali buy / sell sono leggermente diversi.}\label{Figura 15}
\end{thefigure}
\\~\\
...
\begin{thefigure}
	\begin{center}
		\includegraphics[width=\linewidth]{bandit_choice_02} %TODO: risultato esperimento 1000 (oppure se non va a buon fine anche il 100.)
	\end{center}
