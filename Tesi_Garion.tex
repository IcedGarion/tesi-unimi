...
\end{fig}
\\~\\Nelle successive immagini è analizzata la funzione di performance di AI\_0, isolandola dalle altre in Figura 20. Si può notare che la performance di AI\0 è quasi sempre superiore di tutte le altre, considerando picco per picco. 
\begin{fig}
		\begin{subfigure}{\linewidth}
