...
\begin{fig}
	...
	\end{center}
	\caption{Figura: grafico comparativo dei risultati prodotti da 10 differenti AI di Sentyment. In questo caso è analizzata la funzione \textit{performance} (Formula 6) per ciascuna delle AI prese in considerazione. La funzione è calcolata partendo dall'inizio del dataset (BITCOIN-EURO a partire da inizio 2014, fino a inizio 2020) a step di 200 candele orarie. Alcune AI si posizionano sempre in alto rispetto ad altre ed è per questo motivo che è necessario sceglierne una migliore fra tutte. Le migliori si sorpassano spesso lungo il tempo e infatti andrebbero scambiate a periodi di tempo da stabilire.}
\end{fig}
