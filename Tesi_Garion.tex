...
\textcolor{red}{Formule di ohlcv e esempi con immagini e tabelle di creazione}
Le candele sono interamente generate grazie alla libreria di Python \textit{pandas}, chiamando il metodo \textit{resample}:



\section{Indicatori}
\textcolor{red}{Formule e esempi calcolo indicatori SMA EMA MACD RSI e altre statistiche}
